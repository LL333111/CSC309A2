const REACT_APP_BACKEND_URL = "https://luckyacesbackend.up.railway.app";

// /auth/tokens
export async function login(utorid, password) {
  try {
    // request
    const response = await fetch(`${REACT_APP_BACKEND_URL}/auth/tokens`, {
      method: "POST",
      headers: {
...
export async function getLoggedInUser(token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function changePassword(oldPassword, newPassword, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me/password`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function transferTransaction(recipientId, amount, remark, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/${recipientId}/transactions`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function redemptionTransaction(amount, remark, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me/transactions`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function yourTransactions(type, page, promotionId, relatedId, amount, operator, token,) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me/transactions?page=${page}&limit=5${type === null ? "" : `&type=${type}`}${promotionId === null ? "" : `&promotionId=${promotionId}`}${relatedId === null ? "" : `&relatedId=${relatedId}`}${amount === null ? "" : `&amount=${amount}`}${operator === null ? "" : `&operator=${operator}`}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getAllUnprocessedRedemption(page, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me/transactions?type=redemption&processedBy=true&page=${page}&limit=5`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getAllPromotions(name, type, page, started, ended, token, regular) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/promotions?page=${page}&limit=5${name === null ? "" : `&name=${name}`}${type === null ? "" : `&type=${type}`}${started === null ? "" : `&started=${started}`}${ended === null ? "" : `&ended=${ended}`}${regular === "true" ? `&regular=true` : ""}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getAllEvents(name, page, started, ended, location, showFull, published, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events?page=${page}&limit=5${name === null ? "" : `&name=${name}`}${location === null ? "" : `&location=${location}`}${showFull === null ? "" : `&showFull=${showFull}`}${published === null ? "" : `&published=${published}`}${started === null ? "" : `&started=${started}`}${ended === null ? "" : `&ended=${ended}`}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function createEvent(name, description, location, startTime, endTime, capacity, points, token) {
  try {
    ...
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getEventById(eventId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function rsvpToEvent(eventId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/guests/me`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getAllUsers(name, page, role, verified, activated, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users?page=${page}&limit=5${name === null ? "" : `&name=${name}`}${role === null ? "" : `&role=${role}`}${verified === null ? "" : `&verified=${verified}`}${activated === null ? "" : `&activated=${activated}`}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token} `,
...
export async function createPurchase(utorid, spent, promotionIds, remark, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/transactions`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getTransactionById(transactionId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/transactions/${transactionId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function markTransactionSuspicious(transactionId, suspicious, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/transactions/${transactionId}/suspicious`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function processRedemption(transactionId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/transactions/${transactionId}/processed`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function createPromotion(name, description, type, startTime, endTime, minSpending, rate, points, token) {
  try {
    ...
    const response = await fetch(`${REACT_APP_BACKEND_URL}/promotions`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getPromotionById(promotionId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/promotions/${promotionId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getOrganizerEvents(page, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/users/me/organizers?page=${page}&limit=5`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function createRewardTransaction(amount, utorid, remark, token, eventId) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/transactions`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function addOrganizer(utorid, eventId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/organizers`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function removeOrganizer(eventId, userId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/organizers/${userId}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function addGuest(utorid, eventId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/guests`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function removeGuest(eventId, userId, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/events/${eventId}/guests/${userId}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function getNotifications(page, token) {
  try {
    const response = await fetch(`${REACT_APP_BACKEND_URL}/notifications?page=${page}&limit=5`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
